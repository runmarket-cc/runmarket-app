...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: 'row', justifyContent: 'space-between', gap: Spacing[2] },
  statBox: {
    flex: 1,
    alignItems: 'center',
    gap: Spacing[1],
  ...
  healthBtnText: { color: Colors.white, fontSize: FontSize.sm, fontWeight: '700' },
  healthHint: {
    fontSize: FontSize.xs,
    color: Colors.gray400,
    lineHeight: 16,
  ...
  homeBtnText: { color: Colors.navyDark, fontSize: FontSize.base, fontWeight: '700' },
});
